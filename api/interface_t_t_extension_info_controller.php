...
<title>Three20 API: TTExtensionInfoController Class Reference</title>
...
<h1>TTExtensionInfoController Class Reference</h1>  </div>
</div>
<div class="contents">
<!-- doxytag: class="TTExtensionInfoController" --><!-- doxytag: inherits="TTTableViewController" -->
<p>Display information about a specific extension.  
<a href="#_details">More...</a></p>

<p><code>#import &lt;<a class="el" href="_t_t_extension_info_controller_8h_source.php">TTExtensionInfoController.h</a>&gt;</code></p>
<div class="dynheader">
Inheritance diagram for TTExtensionInfoController:</div>
<div class="dyncontent">
 <div class="center">
  <img src="interface_t_t_extension_info_controller.png" usemap="#TTExtensionInfoController_map" alt=""/>
  <map id="TTExtensionInfoController_map" name="TTExtensionInfoController_map">
...
<p><a href="class_t_t_extension_info_controller-members.php">List of all members.</a></p>
<table class="memberdecls">
<tr><td colspan="2"><h2><a name="pri-attribs"></a>
Private Attributes</h2></td></tr>
<tr><td class="memItemLeft" align="right" valign="top"><a class="anchor" id="ab098b92afe2a463edcd8ac394807dd73"></a><!-- doxytag: member="TTExtensionInfoController::_extension" ref="ab098b92afe2a463edcd8ac394807dd73" args="" -->
<a class="el" href="interface_t_t_extension_info.php">TTExtensionInfo</a> *&nbsp;</td><td class="memItemRight" valign="bottom"><b>_extension</b></td></tr>
</table>
<hr/><a name="_details"></a><h2>Detailed Description</h2>
<p>Display information about a specific extension. </p>
<dl class="see"><dt><b>See also:</b></dt><dd><a class="el" href="interface_t_t_extension_info.php">TTExtensionInfo</a> </dd></dl>
<hr/>The documentation for this class was generated from the following file:<ul>
<li>Three20UI/Headers/<a class="el" href="_t_t_extension_info_controller_8h_source.php">TTExtensionInfoController.h</a></li>
</ul>
</div>
