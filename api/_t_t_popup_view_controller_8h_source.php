...
<title>Three20 API: Three20UI/Headers/TTPopupViewController.h Source File</title>
...
<h1>Three20UI/Headers/TTPopupViewController.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00030"></a><a class="code" href="interface_t_t_popup_view_controller.php">00030</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_popup_view_controller.php" title="A view controller which, when displayed modally, inserts its view over the parent controller...">TTPopupViewController</a> : <a class="code" href="interface_t_t_model_view_controller.php" title="A view controller that manages a model in addition to a view.">TTModelViewController</a> {
<a name="l00031"></a>00031 }
<a name="l00032"></a>00032 
<a name="l00033"></a>00033 - (void)showInView:(<a class="code" href="class_u_i_view.php" title="Additions.">UIView</a>*)view animated:(BOOL)animated;
<a name="l00034"></a>00034 - (void)dismissPopupViewControllerAnimated:(BOOL)animated;
<a name="l00035"></a>00035 - (void)showFromBarButtonItem:(UIBarButtonItem *)item animated:(BOOL)animated;
<a name="l00036"></a>00036 - (void)showFromRect:(CGRect)rect inView:(<a class="code" href="class_u_i_view.php" title="Additions.">UIView</a> *)view animated:(BOOL)animated;
