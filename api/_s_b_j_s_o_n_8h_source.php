...
<head>
  ...
  <title>Three20: extThree20JSON/Vendors/JSON/SBJSON.h Source File</title>
...
<h1>extThree20JSON/Vendors/JSON/SBJSON.h</h1>  </div>
</div>
<div class="contents">
<div class="fragment"><pre class="fragment"><a name="l00001"></a>00001 <span class="comment">/*</span>
<a name="l00002"></a>00002 <span class="comment"> Copyright (C) 2007-2009 Stig Brautaset. All rights reserved.</span>
...
<a name="l00031"></a>00031 <span class="preprocessor">#import &quot;extThree20JSON/private/SBJsonParser.h&quot;</span>
<a name="l00032"></a>00032 <span class="preprocessor">#import &quot;extThree20JSON/private/SBJsonWriter.h&quot;</span>
<a name="l00033"></a>00033 
<a name="l00039"></a><a class="code" href="interface_s_b_j_s_o_n.php">00039</a> <span class="keyword">@interface </span><a class="code" href="interface_s_b_j_s_o_n.php" title="Facade for SBJsonWriter/SBJsonParser.">SBJSON</a> : <a class="code" href="interface_s_b_json_base.php" title="Common base class for parsing &amp;amp; writing.">SBJsonBase</a> &lt;<a class="code" href="protocol_s_b_json_parser-p.php" title="Options for the parser class.">SBJsonParser</a>, <a class="code" href="protocol_s_b_json_writer-p.php" title="Options for the writer class.">SBJsonWriter</a>&gt; {
<a name="l00040"></a>00040 
<a name="l00041"></a>00041 <span class="keyword">@private</span>
<a name="l00042"></a>00042     <a class="code" href="interface_s_b_json_parser.php" title="The JSON parser class.">SBJsonParser</a> *jsonParser;
<a name="l00043"></a>00043     <a class="code" href="interface_s_b_json_writer.php" title="The JSON writer class.">SBJsonWriter</a> *jsonWriter;
<a name="l00044"></a>00044 }
<a name="l00045"></a>00045 
<a name="l00046"></a>00046 
<a name="l00048"></a>00048 - (id)fragmentWithString:(<a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>*)jsonrep
<a name="l00049"></a>00049                    error:(NSError**)error;
<a name="l00050"></a>00050 
<a name="l00052"></a>00052 - (id)objectWithString:(<a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>*)jsonrep
<a name="l00053"></a>00053                  error:(NSError**)error;
<a name="l00054"></a>00054 
<a name="l00056"></a>00056 - (id)objectWithString:(<span class="keywordtype">id</span>)value
<a name="l00057"></a>00057            allowScalar:(BOOL)x
<a name="l00058"></a>00058            error:(NSError**)error;
<a name="l00059"></a>00059 
<a name="l00060"></a>00060 
<a name="l00062"></a>00062 - (<a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>*)stringWithObject:(<span class="keywordtype">id</span>)value
<a name="l00063"></a>00063                         error:(NSError**)error;
<a name="l00064"></a>00064 
<a name="l00066"></a>00066 - (<a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>*)stringWithFragment:(<span class="keywordtype">id</span>)value
<a name="l00067"></a>00067                           error:(NSError**)error;
<a name="l00068"></a>00068 
<a name="l00070"></a>00070 - (<a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>*)stringWithObject:(<span class="keywordtype">id</span>)value
<a name="l00071"></a>00071                   allowScalar:(BOOL)x
<a name="l00072"></a>00072               error:(NSError**)error;
<a name="l00073"></a>00073 
<a name="l00074"></a>00074 
<a name="l00075"></a>00075 <span class="keyword">@end</span>
</pre></div></div>
</div>
