...
<title>Three20 API: &lt;YAJLCoding&gt; Protocol Reference</title>
...
<h1>&lt;YAJLCoding&gt; Protocol Reference</h1>  </div>
</div>
<div class="contents">
<!-- doxytag: class="YAJLCoding-p" -->
<p><code>#import &lt;<a class="el" href="_y_a_j_l_gen_8h_source.php">YAJLGen.h</a>&gt;</code></p>

<p><a href="protocol_y_a_j_l_coding-p-members.php">List of all members.</a></p>
<table class="memberdecls">
<tr><td colspan="2"><h2><a name="pub-methods"></a>
Public Member Functions</h2></td></tr>
<tr><td class="memItemLeft" align="right" valign="top">(id)&nbsp;</td><td class="memItemRight" valign="bottom">- <a class="el" href="protocol_y_a_j_l_coding-p.php#a3305ad3a3859fb687685cc6fc24f0e60">JSON</a></td></tr>
</table>
<hr/><a name="_details"></a><h2>Detailed Description</h2>
<p>Custom objects can support manual JSON encoding.</p>
<div class="fragment"><pre class="fragment"> <span class="keyword">@interface </span>CustomObject : <a class="code" href="class_n_s_object.php" title="Additions.">NSObject</a>
 @end

 @implementation CustomObject

 - (id)<a class="code" href="protocol_y_a_j_l_coding-p.php#a3305ad3a3859fb687685cc6fc24f0e60">JSON</a> {
 <span class="keywordflow">return</span> [<a class="code" href="class_n_s_array.php" title="Additions.">NSArray</a> arrayWithObject:[NSNumber numberWithInteger:1]];
 }

 <span class="keyword">@end</span>
</pre></div><p>And then:</p>
<div class="fragment"><pre class="fragment"> CustomObject *customObject = [[CustomObject alloc] init];
 <a class="code" href="class_n_s_string.php" title="Additions.">NSString</a> *JSONString = [customObject yajl_JSON];
 <span class="comment">// JSONString == &quot;[1]&quot;;</span>
</pre></div> <hr/><h2>Member Function Documentation</h2>
<a class="anchor" id="a3305ad3a3859fb687685cc6fc24f0e60"></a><!-- doxytag: member="YAJLCoding&#45;p::JSON" ref="a3305ad3a3859fb687685cc6fc24f0e60" args="()" -->
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">- (id) JSON </td>
          <td></td>
...
<div class="memdoc">
<p>Provide custom and/or encodable object to parse to JSON string. </p>
<dl class="return"><dt><b>Returns:</b></dt><dd>Object encodable as JSON such as <a class="el" href="class_n_s_dictionary.php">NSDictionary</a>, <a class="el" href="class_n_s_array.php" title="Additions.">NSArray</a>, etc </dd></dl>
