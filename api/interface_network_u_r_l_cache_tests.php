...
<title>Three20 API: NetworkURLCacheTests Class Reference</title>
...
<h1>NetworkURLCacheTests Class Reference</h1>  </div>
</div>
<div class="contents">
<!-- doxytag: class="NetworkURLCacheTests" -->
<p>Unit tests for the <a class="el" href="interface_t_t_u_r_l_cache.php" title="A general purpose URL cache for caching data in memory and on disk.">TTURLCache</a> object.  
<a href="#_details">More...</a></p>
<table class="memberdecls">
</table>
<hr/><a name="_details"></a><h2>Detailed Description</h2>
<p>Unit tests for the <a class="el" href="interface_t_t_u_r_l_cache.php" title="A general purpose URL cache for caching data in memory and on disk.">TTURLCache</a> object. </p>
<p>These tests are a part of the comprehensive test suite for the Network functionality of the library. </p>
<hr/>The documentation for this class was generated from the following file:<ul>
<li>Three20Network/UnitTests/NetworkURLCacheTests.m</li>
</ul>
</div>
