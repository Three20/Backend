...
<head>
  ...
  <title>Three20: CoreAdditionTests Class Reference</title>
...
<h1>CoreAdditionTests Class Reference</h1>  </div>
</div>
<div class="contents">
<!-- doxytag: class="CoreAdditionTests" -->
<p>Unit tests for the Core additions found within Three20.  
<a href="#_details">More...</a></p>
<table class="memberdecls">
</table>
<hr/><a name="_details"></a><h2>Detailed Description</h2>
<p>Unit tests for the Core additions found within Three20. </p>
<p>These tests are a part of the comprehensive test suite for the Core functionality of the library.</p>
<p>Notice:</p>
<p>NSDateAdditions cannot be easily tested from a library unit test due to their dependence upon TTLocalizedString. This is because the Three20.bundle file needs to be loaded for TTLocalizedString to work, but the octest framework does not play well with bundles. It tries to load the bundle from /Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator3.0.sdk/Developer/usr/bin which is not a place we can normally copy to from the Xcode project settings. </p>
<hr/>The documentation for this class was generated from the following file:<ul>
<li>Three20Core/UnitTests/CoreAdditionTests.m</li>
</ul>
</div>
