...
<title>Three20 API: Three20UI/Headers/TTUnclippedView.h Source File</title>
...
<h1>Three20UI/Headers/TTUnclippedView.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00024"></a><a class="code" href="interface_t_t_unclipped_view.php">00024</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_unclipped_view.php" title="A utility view that will cause all of its ancestors to stop clipping, ensuring that nothing obscures ...">TTUnclippedView</a> : <a class="code" href="class_u_i_view.php" title="Additions.">UIView</a>
