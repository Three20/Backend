...
<title>Three20 API: Three20UI/Headers/TTView.h Source File</title>
...
<h1>Three20UI/Headers/TTView.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00021"></a>00021 <span class="keyword">@class</span> <a class="code" href="interface_t_t_layout.php">TTLayout</a>;
<a name="l00022"></a>00022 
<a name="l00027"></a><a class="code" href="interface_t_t_view.php">00027</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_view.php" title="A UIView with an attached style and layout that are used to render and layout the view...">TTView</a> : <a class="code" href="class_u_i_view.php" title="Additions.">UIView</a> &lt;<a class="code" href="protocol_t_t_style_delegate-p.php">TTStyleDelegate</a>&gt; {
<a name="l00028"></a>00028   <a class="code" href="interface_t_t_style.php">TTStyle</a>*  _style;
<a name="l00029"></a>00029   <a class="code" href="interface_t_t_layout.php">TTLayout</a>* _layout;
<a name="l00030"></a>00030 }
<a name="l00031"></a>00031 
<a name="l00032"></a>00032 @property (nonatomic, retain) <a class="code" href="interface_t_t_style.php">TTStyle</a>*  style;
<a name="l00033"></a>00033 @property (nonatomic, retain) <a class="code" href="interface_t_t_layout.php">TTLayout</a>* layout;
<a name="l00034"></a>00034 
<a name="l00035"></a>00035 - (<span class="keywordtype">void</span>)drawContent:(CGRect)rect;
