...
<title>Three20 API: TTUnclippedView Class Reference</title>
...
<h1>TTUnclippedView Class Reference</h1>  </div>
</div>
<div class="contents">
<!-- doxytag: class="TTUnclippedView" --><!-- doxytag: inherits="UIView" -->
<p>A utility view that will cause all of its ancestors to stop clipping, ensuring that nothing obscures any of part of this view and its contents.  
<a href="#_details">More...</a></p>

<p><code>#import &lt;<a class="el" href="_t_t_unclipped_view_8h_source.php">TTUnclippedView.h</a>&gt;</code></p>
<div class="dynheader">
Inheritance diagram for TTUnclippedView:</div>
<div class="dyncontent">
 <div class="center">
  <img src="interface_t_t_unclipped_view.png" usemap="#TTUnclippedView_map" alt=""/>
  <map id="TTUnclippedView_map" name="TTUnclippedView_map">
<area href="class_u_i_view.php" alt="UIView" shape="rect" coords="0,0,110,24"/>
</map>
</div>
<table class="memberdecls">
</table>
<hr/><a name="_details"></a><h2>Detailed Description</h2>
<p>A utility view that will cause all of its ancestors to stop clipping, ensuring that nothing obscures any of part of this view and its contents. </p>
<hr/>The documentation for this class was generated from the following file:<ul>
<li>Three20UI/Headers/<a class="el" href="_t_t_unclipped_view_8h_source.php">TTUnclippedView.h</a></li>
</ul>
</div>
