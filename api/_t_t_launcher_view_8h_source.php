...
<title>Three20 API: Three20UI/Headers/TTLauncherView.h Source File</title>
...
<a name="l00026"></a><a class="code" href="interface_t_t_launcher_view.php">00026</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_launcher_view.php">TTLauncherView</a> : <a class="code" href="class_u_i_view.php" title="Additions.">UIView</a> &lt;UIScrollViewDelegate&gt; {
...
<a name="l00064"></a>00064 @property (nonatomic, readonly) <a class="code" href="interface_t_t_page_control.php" title="TTPageControl is a version of UIPageControl which allows you to style the dots.">TTPageControl</a>* pager;
<a name="l00065"></a>00065 
<a name="l00066"></a>00066 @property (nonatomic) NSInteger currentPageIndex;
<a name="l00067"></a>00067 
<a name="l00068"></a>00068 @property (nonatomic, copy) <a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>* prompt;
<a name="l00069"></a>00069 
<a name="l00070"></a>00070 @property (nonatomic, readonly) BOOL editing;
<a name="l00071"></a>00071 
<a name="l00072"></a>00072 - (<span class="keywordtype">void</span>)addItem:(<a class="code" href="interface_t_t_launcher_item.php">TTLauncherItem</a>*)item animated:(BOOL)animated;
<a name="l00073"></a>00073 
<a name="l00074"></a>00074 - (<span class="keywordtype">void</span>)removeItem:(<a class="code" href="interface_t_t_launcher_item.php">TTLauncherItem</a>*)item animated:(BOOL)animated;
<a name="l00075"></a>00075 
<a name="l00076"></a>00076 - (<a class="code" href="interface_t_t_launcher_item.php">TTLauncherItem</a>*)itemWithURL:(<a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>*)URL;
<a name="l00077"></a>00077 
<a name="l00078"></a>00078 - (NSIndexPath*)indexPathOfItem:(<a class="code" href="interface_t_t_launcher_item.php">TTLauncherItem</a>*)item;
<a name="l00079"></a>00079 
<a name="l00080"></a>00080 - (<span class="keywordtype">void</span>)scrollToItem:(<a class="code" href="interface_t_t_launcher_item.php">TTLauncherItem</a>*)item animated:(BOOL)animated;
<a name="l00081"></a>00081 
<a name="l00082"></a>00082 - (<span class="keywordtype">void</span>)beginEditing;
<a name="l00083"></a>00083 
<a name="l00084"></a>00084 - (<span class="keywordtype">void</span>)endEditing;
<a name="l00085"></a>00085 
<a name="l00092"></a>00092 - (<span class="keywordtype">void</span>)beginHighlightItem:(<a class="code" href="interface_t_t_launcher_item.php">TTLauncherItem</a>*)item withText:(<a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>*)text;
<a name="l00093"></a>00093 
<a name="l00098"></a>00098 - (<span class="keywordtype">void</span>)endHighlightItem:(<a class="code" href="interface_t_t_launcher_item.php">TTLauncherItem</a>*)item;
