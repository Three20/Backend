...
<title>Three20 API: Three20UI/Headers/TTTabItem.h Source File</title>
...
<h1>Three20UI/Headers/TTTabItem.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00019"></a>00019 <span class="keyword">@class</span> <a class="code" href="interface_t_t_tab_bar.php">TTTabBar</a>;
<a name="l00020"></a>00020 
<a name="l00021"></a><a class="code" href="interface_t_t_tab_item.php">00021</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_tab_item.php">TTTabItem</a> : <a class="code" href="class_n_s_object.php" title="Additions.">NSObject</a> {
<a name="l00022"></a>00022   <a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>* _title;
<a name="l00023"></a>00023   <a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>* _icon;
<a name="l00024"></a>00024   <span class="keywordtype">id</span>        _object;
<a name="l00025"></a>00025   <span class="keywordtype">int</span>       _badgeNumber;
<a name="l00026"></a>00026   <a class="code" href="interface_t_t_tab_bar.php">TTTabBar</a>* _tabBar;
<a name="l00027"></a>00027 }
<a name="l00028"></a>00028 
<a name="l00029"></a>00029 @property (nonatomic, copy)   <a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>* title;
<a name="l00030"></a>00030 @property (nonatomic, copy)   <a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>* icon;
<a name="l00031"></a>00031 @property (nonatomic, retain) <span class="keywordtype">id</span>        <span class="keywordtype">object</span>;
<a name="l00032"></a>00032 @property (nonatomic)         <span class="keywordtype">int</span>       badgeNumber;
<a name="l00033"></a>00033 
<a name="l00034"></a>00034 - (<span class="keywordtype">id</span>)initWithTitle:(<a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>*)title;
