...
<title>Three20 API: Three20UI/Headers/TTViewController.h Source File</title>
...
<h1>Three20UI/Headers/TTViewController.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00017"></a>00017 <span class="preprocessor">#import &quot;Three20UINavigator/TTNavigatorViewController.h&quot;</span>
<a name="l00018"></a>00018 
<a name="l00019"></a>00019 <span class="keyword">@class</span> <a class="code" href="interface_t_t_table_view_controller.php">TTTableViewController</a>;
<a name="l00020"></a>00020 <span class="keyword">@class</span> <a class="code" href="interface_t_t_search_display_controller.php" title="Shows search results using a TTTableViewController.">TTSearchDisplayController</a>;
<a name="l00021"></a>00021 
<a name="l00025"></a><a class="code" href="interface_t_t_view_controller.php">00025</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_view_controller.php" title="A view controller with some useful additions.">TTViewController</a> : <a class="code" href="interface_t_t_navigator_view_controller.php" title="Cleans up navigator properties when the controller is released.">TTNavigatorViewController</a> {
<a name="l00026"></a>00026 <span class="keyword">@protected</span>
<a name="l00027"></a>00027   <a class="code" href="interface_t_t_search_display_controller.php" title="Shows search results using a TTTableViewController.">TTSearchDisplayController</a>* _searchController;
<a name="l00028"></a>00028 }
<a name="l00029"></a>00029 
<a name="l00038"></a><a class="code" href="interface_t_t_view_controller.php#aee5cb350b30e5feefffd3f118df21f86">00038</a> @property (nonatomic, retain) <a class="code" href="interface_t_t_table_view_controller.php">TTTableViewController</a>* searchViewController;
<a name="l00039"></a>00039 
<a name="l00046"></a>00046 + (<span class="keywordtype">void</span>)doGarbageCollection;
