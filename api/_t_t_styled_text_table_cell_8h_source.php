...
<title>Three20 API: Three20UI/Headers/TTStyledTextTableCell.h Source File</title>
...
<h1>Three20UI/Headers/TTStyledTextTableCell.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00020"></a>00020 <span class="keyword">@class</span> <a class="code" href="interface_t_t_styled_text_label.php" title="A view that can display styled text.">TTStyledTextLabel</a>;
<a name="l00021"></a>00021 
<a name="l00022"></a><a class="code" href="interface_t_t_styled_text_table_cell.php">00022</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_styled_text_table_cell.php">TTStyledTextTableCell</a> : <a class="code" href="interface_t_t_table_view_cell.php" title="The base class for table cells which are single-object based.">TTTableViewCell</a> {
<a name="l00023"></a>00023   <a class="code" href="interface_t_t_styled_text_label.php" title="A view that can display styled text.">TTStyledTextLabel</a>* _label;
<a name="l00024"></a>00024 }
<a name="l00025"></a>00025 
<a name="l00026"></a>00026 @property (nonatomic, readonly) <a class="code" href="interface_t_t_styled_text_label.php" title="A view that can display styled text.">TTStyledTextLabel</a>* label;
