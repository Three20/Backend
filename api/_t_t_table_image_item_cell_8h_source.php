...
<title>Three20 API: Three20UI/Headers/TTTableImageItemCell.h Source File</title>
...
<h1>Three20UI/Headers/TTTableImageItemCell.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00018"></a>00018 <span class="preprocessor">#import &quot;Three20UI/TTTableTextItemCell.h&quot;</span>
...
<a name="l00022"></a><a class="code" href="interface_t_t_table_image_item_cell.php">00022</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_table_image_item_cell.php">TTTableImageItemCell</a> : <a class="code" href="interface_t_t_table_text_item_cell.php">TTTableTextItemCell</a> {
...
<a name="l00026"></a>00026 @property (nonatomic, readonly, retain) <a class="code" href="interface_t_t_image_view.php" title="A view that asynchronously loads an image and subsequently displays it.">TTImageView</a>* imageView2;
