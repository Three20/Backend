...
<title>Three20 API: Three20UI/Headers/TTTableSubtitleItemCell.h Source File</title>
...
<h1>Three20UI/Headers/TTTableSubtitleItemCell.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00022"></a><a class="code" href="interface_t_t_table_subtitle_item_cell.php">00022</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_table_subtitle_item_cell.php">TTTableSubtitleItemCell</a> : <a class="code" href="interface_t_t_table_linked_item_cell.php">TTTableLinkedItemCell</a> {
<a name="l00023"></a>00023   <a class="code" href="interface_t_t_image_view.php" title="A view that asynchronously loads an image and subsequently displays it.">TTImageView</a>* _imageView2;
<a name="l00024"></a>00024 }
<a name="l00025"></a>00025 
<a name="l00026"></a>00026 @property (nonatomic, readonly, retain) UILabel*      subtitleLabel;
<a name="l00027"></a>00027 @property (nonatomic, readonly, retain) <a class="code" href="interface_t_t_image_view.php" title="A view that asynchronously loads an image and subsequently displays it.">TTImageView</a>*  imageView2;
