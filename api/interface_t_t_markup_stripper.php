...
<title>Three20 API: TTMarkupStripper Class Reference</title>
...
<h1>TTMarkupStripper Class Reference</h1>  </div>
</div>
<div class="contents">
<!-- doxytag: class="TTMarkupStripper" --><!-- doxytag: inherits="NSObject" --><div class="dynheader">
Inheritance diagram for TTMarkupStripper:</div>
<div class="dyncontent">
 <div class="center">
  <img src="interface_t_t_markup_stripper.png" usemap="#TTMarkupStripper_map" alt=""/>
  <map id="TTMarkupStripper_map" name="TTMarkupStripper_map">
<area href="class_n_s_object.php" alt="NSObject" shape="rect" coords="0,0,114,24"/>
</map>
</div>

<p><a href="class_t_t_markup_stripper-members.php">List of all members.</a></p>
<table class="memberdecls">
<tr><td colspan="2"><h2><a name="pub-methods"></a>
Public Member Functions</h2></td></tr>
<tr><td class="memItemLeft" align="right" valign="top"><a class="anchor" id="ab0da319fbd05ae953f41f91f0440473d"></a><!-- doxytag: member="TTMarkupStripper::parse:" ref="ab0da319fbd05ae953f41f91f0440473d" args="(NSString *string)" -->
(<a class="el" href="class_n_s_string.php">NSString</a> *)&nbsp;</td><td class="memItemRight" valign="bottom">- <a class="el" href="interface_t_t_markup_stripper.php#ab0da319fbd05ae953f41f91f0440473d">parse:</a></td></tr>
<tr><td class="mdescLeft">&nbsp;</td><td class="mdescRight">Strips markup from the given string and returns the result. <br/></td></tr>
<tr><td colspan="2"><h2><a name="pri-attribs"></a>
Private Attributes</h2></td></tr>
<tr><td class="memItemLeft" align="right" valign="top"><a class="anchor" id="a153bd1aeda6def20bd6bce91347200ab"></a><!-- doxytag: member="TTMarkupStripper::_strings" ref="a153bd1aeda6def20bd6bce91347200ab" args="" -->
<a class="el" href="class_n_s_mutable_array.php">NSMutableArray</a> *&nbsp;</td><td class="memItemRight" valign="bottom"><b>_strings</b></td></tr>
</table>
<hr/>The documentation for this class was generated from the following files:<ul>
<li>Three20Core/Headers/<a class="el" href="_t_t_markup_stripper_8h_source.php">TTMarkupStripper.h</a></li>
<li>Three20Core/Sources/TTMarkupStripper.m</li>
</ul>
</div>
