...
<title>Three20 API: Three20UI/Headers/TTTableViewPlainVarHeightDelegate.h Source File</title>
...
<h1>Three20UI/Headers/TTTableViewPlainVarHeightDelegate.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00020"></a><a class="code" href="interface_t_t_table_view_plain_var_height_delegate.php">00020</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_table_view_plain_var_height_delegate.php">TTTableViewPlainVarHeightDelegate</a> : <a class="code" href="interface_t_t_table_view_var_height_delegate.php" title="A table view delegate that queries the cell items for their height.">TTTableViewVarHeightDelegate</a> {
