...
<title>Three20 API: Three20UI/Headers/TTImageViewDelegate.h Source File</title>
...
<h1>Three20UI/Headers/TTImageViewDelegate.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00022"></a><a class="code" href="protocol_t_t_image_view_delegate-p.php">00022</a> <span class="keyword">@protocol </span><a class="code" href="protocol_t_t_image_view_delegate-p.php">TTImageViewDelegate</a> &lt;<a class="code" href="class_n_s_object.php" title="Additions.">NSObject</a>&gt;
<a name="l00023"></a>00023 <span class="keyword">@optional</span>
<a name="l00024"></a>00024 
<a name="l00028"></a>00028 - (void)imageViewDidStartLoad:(<a class="code" href="interface_t_t_image_view.php" title="A view that asynchronously loads an image and subsequently displays it.">TTImageView</a>*)imageView;
<a name="l00029"></a>00029 
<a name="l00033"></a>00033 - (void)imageView:(<a class="code" href="interface_t_t_image_view.php" title="A view that asynchronously loads an image and subsequently displays it.">TTImageView</a>*)imageView didLoadImage:(<a class="code" href="class_u_i_image.php" title="Additions.">UIImage</a>*)image;
<a name="l00034"></a>00034 
<a name="l00039"></a>00039 - (void)imageView:(<a class="code" href="interface_t_t_image_view.php" title="A view that asynchronously loads an image and subsequently displays it.">TTImageView</a>*)imageView didFailLoadWithError:(NSError*)error;
<a name="l00040"></a>00040 
<a name="l00041"></a>00041 <span class="keyword">@end</span>
</pre></div></div>
</div>
