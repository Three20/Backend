...
<title>Three20 API: UISplitViewController Class Reference</title>
...
<h1>UISplitViewController Class Reference</h1>  </div>
</div>
<div class="contents">
<!-- doxytag: class="UISplitViewController" --><div class="dynheader">
Inheritance diagram for UISplitViewController:</div>
<div class="dyncontent">
 <div class="center">
  <img src="class_u_i_split_view_controller.png" usemap="#UISplitViewController_map" alt=""/>
  <map id="UISplitViewController_map" name="UISplitViewController_map">
<area href="interface_t_t_split_view_controller.php" alt="TTSplitViewController" shape="rect" coords="0,56,134,80"/>
</map>
</div>
<table class="memberdecls">
</table>
<hr/>The documentation for this class was generated from the following file:<ul>
<li>Three20UICommon/Sources/UISplitViewController+TTNavigator.m</li>
</ul>
</div>
