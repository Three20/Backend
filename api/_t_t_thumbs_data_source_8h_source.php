...
<title>Three20 API: Three20UI/Headers/TTThumbsDataSource.h Source File</title>
...
<h1>Three20UI/Headers/TTThumbsDataSource.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00020"></a>00020 <span class="keyword">@protocol </span><a class="code" href="protocol_t_t_photo_source-p.php">TTPhotoSource</a>;
...
<a name="l00023"></a><a class="code" href="interface_t_t_thumbs_data_source.php">00023</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_thumbs_data_source.php">TTThumbsDataSource</a> : <a class="code" href="interface_t_t_table_view_data_source.php">TTTableViewDataSource</a> {
<a name="l00024"></a>00024   id&lt;TTPhotoSource&gt;                 _photoSource;
<a name="l00025"></a>00025   id&lt;TTThumbsTableViewCellDelegate&gt; _delegate;
<a name="l00026"></a>00026 }
<a name="l00027"></a>00027 
<a name="l00028"></a>00028 @property (nonatomic, retain) id&lt;<a class="code" href="protocol_t_t_photo_source-p.php">TTPhotoSource</a>&gt;                 photoSource;
<a name="l00029"></a>00029 @property (nonatomic, assign) <span class="keywordtype">id</span>&lt;<a class="code" href="protocol_t_t_thumbs_table_view_cell_delegate-p.php">TTThumbsTableViewCellDelegate</a>&gt; delegate;
<a name="l00030"></a>00030 
<a name="l00031"></a>00031 - (<span class="keywordtype">id</span>)initWithPhotoSource: (<span class="keywordtype">id</span>&lt;<a class="code" href="protocol_t_t_photo_source-p.php">TTPhotoSource</a>&gt;)photoSource
<a name="l00032"></a>00032                  delegate: (<span class="keywordtype">id</span>&lt;<a class="code" href="protocol_t_t_thumbs_table_view_cell_delegate-p.php">TTThumbsTableViewCellDelegate</a>&gt;)delegate;
