...
<title>Three20 API: CoreGlobalTests Class Reference</title>
...
<h1>CoreGlobalTests Class Reference</h1>  </div>
</div>
<div class="contents">
<!-- doxytag: class="CoreGlobalTests" -->
<p>Unit tests for the global methods found within Three20.  
<a href="#_details">More...</a></p>
<table class="memberdecls">
</table>
<hr/><a name="_details"></a><h2>Detailed Description</h2>
<p>Unit tests for the global methods found within Three20. </p>
<p>These tests are a part of the comprehensive test suite for the Core functionality of the library. </p>
<hr/>The documentation for this class was generated from the following file:<ul>
<li>Three20Core/UnitTests/CoreGlobalTests.m</li>
</ul>
</div>
