...
<title>Three20 API: NetworkModelTests Class Reference</title>
...
<h1>NetworkModelTests Class Reference</h1>  </div>
</div>
<div class="contents">
<!-- doxytag: class="NetworkModelTests" -->
<p>Unit tests for the Network model found within Three20.  
<a href="#_details">More...</a></p>
<table class="memberdecls">
</table>
<hr/><a name="_details"></a><h2>Detailed Description</h2>
<p>Unit tests for the Network model found within Three20. </p>
<p>These tests are a part of the comprehensive test suite for the Network functionality of the library. </p>
<hr/>The documentation for this class was generated from the following file:<ul>
<li>Three20Network/UnitTests/NetworkModelTests.m</li>
</ul>
</div>
