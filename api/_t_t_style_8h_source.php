...
<title>Three20 API: Three20Style/Headers/TTStyle.h Source File</title>
...
<h1>Three20Style/Headers/TTStyle.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00020"></a>00020 <span class="keyword">@class</span> <a class="code" href="interface_t_t_style_context.php">TTStyleContext</a>;
<a name="l00021"></a>00021 
<a name="l00022"></a><a class="code" href="interface_t_t_style.php">00022</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_style.php">TTStyle</a> : <a class="code" href="class_n_s_object.php" title="Additions.">NSObject</a> {
<a name="l00023"></a>00023   <a class="code" href="interface_t_t_style.php">TTStyle</a>* _next;
<a name="l00024"></a>00024 }
<a name="l00025"></a>00025 
<a name="l00026"></a>00026 @property (nonatomic, retain) <a class="code" href="interface_t_t_style.php">TTStyle</a>* next;
<a name="l00027"></a>00027 
<a name="l00028"></a>00028 - (<span class="keywordtype">id</span>)initWithNext:(<a class="code" href="interface_t_t_style.php">TTStyle</a>*)next;
<a name="l00029"></a>00029 
<a name="l00030"></a>00030 - (<a class="code" href="interface_t_t_style.php">TTStyle</a>*)next:(<a class="code" href="interface_t_t_style.php">TTStyle</a>*)next;
<a name="l00031"></a>00031 
<a name="l00032"></a>00032 - (<span class="keywordtype">void</span>)draw:(<a class="code" href="interface_t_t_style_context.php">TTStyleContext</a>*)context;
<a name="l00033"></a>00033 
<a name="l00034"></a>00034 - (UIEdgeInsets)addToInsets:(UIEdgeInsets)insets forSize:(CGSize)size;
<a name="l00035"></a>00035 - (CGSize)addToSize:(CGSize)size context:(<a class="code" href="interface_t_t_style_context.php">TTStyleContext</a>*)context;
<a name="l00036"></a>00036 
<a name="l00037"></a>00037 - (<span class="keywordtype">void</span>)addStyle:(<a class="code" href="interface_t_t_style.php">TTStyle</a>*)style;
<a name="l00038"></a>00038 
<a name="l00039"></a>00039 - (<span class="keywordtype">id</span>)firstStyleOfClass:(Class)cls;
<a name="l00040"></a>00040 - (<span class="keywordtype">id</span>)styleForPart:(<a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>*)name;
