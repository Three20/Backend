...
<title>Three20 API: extJSONTests Class Reference</title>
...
<h1>extJSONTests Class Reference</h1>  </div>
</div>
<div class="contents">
<!-- doxytag: class="extJSONTests" -->
<p>Unit tests for the Core JSON parser.  
<a href="#_details">More...</a></p>
<table class="memberdecls">
</table>
<hr/><a name="_details"></a><h2>Detailed Description</h2>
<p>Unit tests for the Core JSON parser. </p>
<p>These tests are a part of the comprehensive test suite for the Core functionality of the library. </p>
<hr/>The documentation for this class was generated from the following file:<ul>
<li>extThree20JSON/UnitTests/extJSONTests+SBJSON.m</li>
</ul>
</div>
