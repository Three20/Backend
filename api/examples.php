...
<title>Three20 API: Examples</title>
...
<div class="navigation" id="top">
  <div class="tabs">
    <ul class="tablist">
      ...
      <li class="current"><a href="examples.php"><span>Examples</span></a></li>
      <li id="searchli">
...
<li><a class="el" href="_g_e_t-example.php">GET</a></li>

<li><a class="el" href="_p_o_s_t-example.php">POST</a></li>

<li><a class="el" href="_p_u_t-example.php">PUT</a></li>
