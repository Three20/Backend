...
<title>Three20 API: CoreMarkupStripperTests Class Reference</title>
...
<h1>CoreMarkupStripperTests Class Reference</h1>  </div>
</div>
<div class="contents">
<!-- doxytag: class="CoreMarkupStripperTests" -->
<p>Unit tests for the markup stripper found within Three20.  
<a href="#_details">More...</a></p>
<table class="memberdecls">
</table>
<hr/><a name="_details"></a><h2>Detailed Description</h2>
<p>Unit tests for the markup stripper found within Three20. </p>
<p>These tests are a part of the comprehensive test suite for the Core functionality of the library. </p>
<hr/>The documentation for this class was generated from the following file:<ul>
<li>Three20Core/UnitTests/CoreMarkupStripperTests.m</li>
</ul>
</div>
