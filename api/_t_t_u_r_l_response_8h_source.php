...
<title>Three20 API: Three20Network/Headers/TTURLResponse.h Source File</title>
...
<h1>Three20Network/Headers/TTURLResponse.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00030"></a><a class="code" href="protocol_t_t_u_r_l_response-p.php">00030</a> <span class="keyword">@protocol </span><a class="code" href="protocol_t_t_u_r_l_response-p.php" title="A response protocol for TTURLRequest.">TTURLResponse</a> &lt;<a class="code" href="class_n_s_object.php" title="Additions.">NSObject</a>&gt;
<a name="l00031"></a>00031 <span class="keyword">@required</span>
<a name="l00032"></a>00032 
<a name="l00045"></a>00045 - (NSError*)request:(<a class="code" href="interface_t_t_u_r_l_request.php" title="The Three20 network request object, built to work with the Three20 cache and co.">TTURLRequest</a>*)request processResponse:(NSHTTPURLResponse*)response
<a name="l00046"></a>00046             data:(<span class="keywordtype">id</span>)data;
