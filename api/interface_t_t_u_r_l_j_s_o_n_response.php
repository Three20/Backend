...
<head>
  ...
  <title>Three20: TTURLJSONResponse Class Reference</title>
...
<h1>TTURLJSONResponse Class Reference</h1>  </div>
</div>
<div class="contents">
<!-- doxytag: class="TTURLJSONResponse" --><!-- doxytag: inherits="NSObject,TTURLResponse-p" -->
<p>An implementation of the <a class="el" href="protocol_t_t_u_r_l_response-p.php" title="A response protocol for TTURLRequest.">TTURLResponse</a> protocal for turning JSON responses into NSObjects.  
<a href="#_details">More...</a></p>

<p><code>#import &lt;<a class="el" href="_t_t_u_r_l_j_s_o_n_response_8h_source.php">TTURLJSONResponse.h</a>&gt;</code></p>
<div class="dynheader">
Inheritance diagram for TTURLJSONResponse:</div>
<div class="dyncontent">
 <div class="center">
  <img src="interface_t_t_u_r_l_j_s_o_n_response.png" usemap="#TTURLJSONResponse_map" alt=""/>
  <map id="TTURLJSONResponse_map" name="TTURLJSONResponse_map">
<area href="class_n_s_object.php" alt="NSObject" shape="rect" coords="0,0,138,24"/>
<area href="protocol_t_t_u_r_l_response-p.php" alt="&lt;TTURLResponse&gt;" shape="rect" coords="148,0,286,24"/>
</map>
</div>

<p><a href="class_t_t_u_r_l_j_s_o_n_response-members.php">List of all members.</a></p>
...
<tr><td class="memItemLeft" align="right" valign="top"><a class="anchor" id="a6458c1a046d5d57bf978b6f2d4e82ace"></a><!-- doxytag: member="TTURLJSONResponse::_rootObject" ref="a6458c1a046d5d57bf978b6f2d4e82ace" args="" -->
id&nbsp;</td><td class="memItemRight" valign="bottom"><b>_rootObject</b></td></tr>
<tr><td colspan="2"><h2><a name="properties"></a>
Properties</h2></td></tr>
<tr><td class="memItemLeft" align="right" valign="top"><a class="anchor" id="a4c1cc44247ae9162b2c08eae714671a2"></a><!-- doxytag: member="TTURLJSONResponse::rootObject" ref="a4c1cc44247ae9162b2c08eae714671a2" args="" -->
id&nbsp;</td><td class="memItemRight" valign="bottom"><b>rootObject</b></td></tr>
</table>
<hr/><a name="_details"></a><h2>Detailed Description</h2>
<p>An implementation of the <a class="el" href="protocol_t_t_u_r_l_response-p.php" title="A response protocol for TTURLRequest.">TTURLResponse</a> protocal for turning JSON responses into NSObjects. </p>
<hr/><h2>Member Function Documentation</h2>
<a class="anchor" id="a92fe1507b1789dfe686f047bffc61f34"></a><!-- doxytag: member="TTURLJSONResponse::request:processResponse:data:" ref="a92fe1507b1789dfe686f047bffc61f34" args="(TTURLRequest *request,[processResponse] NSHTTPURLResponse *response,[data] id data)" -->
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
...
<li>extThree20JSON/Headers/<a class="el" href="_t_t_u_r_l_j_s_o_n_response_8h_source.php">TTURLJSONResponse.h</a></li>
</ul>
</div>
