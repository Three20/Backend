...
<title>Three20 API: Three20UI/Headers/TTTableTextItem.h Source File</title>
...
<h1>Three20UI/Headers/TTTableTextItem.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00020"></a><a class="code" href="interface_t_t_table_text_item.php">00020</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_table_text_item.php">TTTableTextItem</a> : <a class="code" href="interface_t_t_table_linked_item.php">TTTableLinkedItem</a> {
<a name="l00021"></a>00021   <a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>* _text;
<a name="l00022"></a>00022 }
<a name="l00023"></a>00023 
<a name="l00024"></a>00024 @property (nonatomic, copy) <a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>* text;
<a name="l00025"></a>00025 
<a name="l00026"></a>00026 + (<span class="keywordtype">id</span>)itemWithText:(<a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>*)text;
<a name="l00027"></a>00027 + (<span class="keywordtype">id</span>)itemWithText:(<a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>*)text URL:(<a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>*)URL;
<a name="l00028"></a>00028 + (<span class="keywordtype">id</span>)itemWithText:(<a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>*)text URL:(<a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>*)URL accessoryURL:(<a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>*)accessoryURL;
<a name="l00029"></a>00029 
<a name="l00030"></a>00030 + (<span class="keywordtype">id</span>)itemWithText:(<a class="code" href="class_n_s_string.php" title="Additions.">NSString</a>*)text delegate:(<span class="keywordtype">id</span>)delegate selector:(<span class="keywordtype">SEL</span>)selector;
