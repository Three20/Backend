...
<title>Three20 API: Three20UI/Headers/TTTableFlushViewCell.h Source File</title>
...
<h1>Three20UI/Headers/TTTableFlushViewCell.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00020"></a>00020 <span class="keyword">@class</span> <a class="code" href="interface_t_t_table_view_item.php">TTTableViewItem</a>;
<a name="l00021"></a>00021 
<a name="l00022"></a><a class="code" href="interface_t_t_table_flush_view_cell.php">00022</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_table_flush_view_cell.php">TTTableFlushViewCell</a> : <a class="code" href="interface_t_t_table_view_cell.php" title="The base class for table cells which are single-object based.">TTTableViewCell</a> {
<a name="l00023"></a>00023   <a class="code" href="interface_t_t_table_view_item.php">TTTableViewItem</a>*  _item;
<a name="l00024"></a>00024   <a class="code" href="class_u_i_view.php" title="Additions.">UIView</a>*           _view;
<a name="l00025"></a>00025 }
<a name="l00026"></a>00026 
<a name="l00027"></a>00027 @property (nonatomic, readonly, retain) <a class="code" href="interface_t_t_table_view_item.php">TTTableViewItem</a>*  item;
<a name="l00028"></a>00028 @property (nonatomic, readonly, retain) <a class="code" href="class_u_i_view.php" title="Additions.">UIView</a>*           view;
