...
<head>
  ...
  <title>Three20: TTURLDataResponse Class Reference</title>
...
<h1>TTURLDataResponse Class Reference</h1>  </div>
</div>
<div class="contents">
<!-- doxytag: class="TTURLDataResponse" --><!-- doxytag: inherits="NSObject,TTURLResponse-p" -->
<p>An implementation of the <a class="el" href="protocol_t_t_u_r_l_response-p.php" title="A response protocol for TTURLRequest.">TTURLResponse</a> protocal for generic <a class="el" href="class_n_s_data.php" title="Additions.">NSData</a> objects.  
<a href="#_details">More...</a></p>

<p><code>#import &lt;<a class="el" href="_t_t_u_r_l_data_response_8h_source.php">TTURLDataResponse.h</a>&gt;</code></p>
<div class="dynheader">
Inheritance diagram for TTURLDataResponse:</div>
<div class="dyncontent">
 <div class="center">
  <img src="interface_t_t_u_r_l_data_response.png" usemap="#TTURLDataResponse_map" alt=""/>
  <map id="TTURLDataResponse_map" name="TTURLDataResponse_map">
<area href="class_n_s_object.php" alt="NSObject" shape="rect" coords="0,0,130,24"/>
<area href="protocol_t_t_u_r_l_response-p.php" alt="&lt;TTURLResponse&gt;" shape="rect" coords="140,0,270,24"/>
</map>
</div>

<p><a href="class_t_t_u_r_l_data_response-members.php">List of all members.</a></p>
...
<tr><td class="memItemLeft" align="right" valign="top"><a class="anchor" id="a1641527b45c019584161390d151eb86f"></a><!-- doxytag: member="TTURLDataResponse::_data" ref="a1641527b45c019584161390d151eb86f" args="" -->
<a class="el" href="class_n_s_data.php">NSData</a> *&nbsp;</td><td class="memItemRight" valign="bottom"><b>_data</b></td></tr>
<tr><td colspan="2"><h2><a name="properties"></a>
Properties</h2></td></tr>
<tr><td class="memItemLeft" align="right" valign="top"><a class="anchor" id="a32a4f0c8e157a59467ea48a22627778b"></a><!-- doxytag: member="TTURLDataResponse::data" ref="a32a4f0c8e157a59467ea48a22627778b" args="" -->
<a class="el" href="class_n_s_data.php">NSData</a> *&nbsp;</td><td class="memItemRight" valign="bottom"><b>data</b></td></tr>
</table>
<hr/><a name="_details"></a><h2>Detailed Description</h2>
<p>An implementation of the <a class="el" href="protocol_t_t_u_r_l_response-p.php" title="A response protocol for TTURLRequest.">TTURLResponse</a> protocal for generic <a class="el" href="class_n_s_data.php" title="Additions.">NSData</a> objects. </p>
<hr/><h2>Member Function Documentation</h2>
<a class="anchor" id="a92fe1507b1789dfe686f047bffc61f34"></a><!-- doxytag: member="TTURLDataResponse::request:processResponse:data:" ref="a92fe1507b1789dfe686f047bffc61f34" args="(TTURLRequest *request,[processResponse] NSHTTPURLResponse *response,[data] id data)" -->
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
...
<li>Three20Network/Headers/<a class="el" href="_t_t_u_r_l_data_response_8h_source.php">TTURLDataResponse.h</a></li>
</ul>
</div>
