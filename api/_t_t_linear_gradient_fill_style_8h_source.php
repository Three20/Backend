...
<title>Three20 API: Three20Style/Headers/TTLinearGradientFillStyle.h Source File</title>
...
<h1>Three20Style/Headers/TTLinearGradientFillStyle.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00020"></a><a class="code" href="interface_t_t_linear_gradient_fill_style.php">00020</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_linear_gradient_fill_style.php">TTLinearGradientFillStyle</a> : <a class="code" href="interface_t_t_style.php">TTStyle</a> {
...
<a name="l00025"></a>00025 @property (nonatomic, retain) <a class="code" href="class_u_i_color.php" title="Additions.">UIColor</a>* color1;
<a name="l00026"></a>00026 @property (nonatomic, retain) <a class="code" href="class_u_i_color.php" title="Additions.">UIColor</a>* color2;
<a name="l00027"></a>00027 
<a name="l00028"></a>00028 + (<a class="code" href="interface_t_t_linear_gradient_fill_style.php">TTLinearGradientFillStyle</a>*)styleWithColor1:(<a class="code" href="class_u_i_color.php" title="Additions.">UIColor</a>*)color1 color2:(<a class="code" href="class_u_i_color.php" title="Additions.">UIColor</a>*)color2
<a name="l00029"></a>00029                                          next:(<a class="code" href="interface_t_t_style.php">TTStyle</a>*)next;
