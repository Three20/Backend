...
<title>Three20 API: Three20Style/Headers/TTShadowStyle.h Source File</title>
...
<h1>Three20Style/Headers/TTShadowStyle.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00020"></a><a class="code" href="interface_t_t_shadow_style.php">00020</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_shadow_style.php">TTShadowStyle</a> : <a class="code" href="interface_t_t_style.php">TTStyle</a> {
<a name="l00021"></a>00021   <a class="code" href="class_u_i_color.php" title="Additions.">UIColor</a>*  _color;
<a name="l00022"></a>00022   CGFloat   _blur;
<a name="l00023"></a>00023   CGSize    _offset;
...
<a name="l00027"></a>00027 @property (nonatomic)         CGFloat   blur;
<a name="l00028"></a>00028 @property (nonatomic)         CGSize    offset;
<a name="l00029"></a>00029 
<a name="l00030"></a>00030 + (<a class="code" href="interface_t_t_shadow_style.php">TTShadowStyle</a>*)styleWithColor:(<a class="code" href="class_u_i_color.php" title="Additions.">UIColor</a>*)color blur:(CGFloat)blur offset:(CGSize)offset
<a name="l00031"></a>00031                             next:(<a class="code" href="interface_t_t_style.php">TTStyle</a>*)next;
