...
<head>
  ...
  <title>Three20: SBJsonBase Class Reference</title>
...
<h1>SBJsonBase Class Reference</h1>  </div>
</div>
<div class="contents">
<!-- doxytag: class="SBJsonBase" --><!-- doxytag: inherits="NSObject" -->
<p>Common base class for parsing &amp; writing.  
<a href="#_details">More...</a></p>

<p><code>#import &lt;<a class="el" href="_s_b_json_base_8h_source.php">SBJsonBase.h</a>&gt;</code></p>
<div class="dynheader">
Inheritance diagram for SBJsonBase:</div>
<div class="dyncontent">
 <div class="center">
  <img src="interface_s_b_json_base.png" usemap="#SBJsonBase_map" alt=""/>
  <map id="SBJsonBase_map" name="SBJsonBase_map">
<area href="class_n_s_object.php" alt="NSObject" shape="rect" coords="103,0,196,24"/>
<area href="interface_s_b_j_s_o_n.php" alt="SBJSON" shape="rect" coords="0,112,93,136"/>
<area href="interface_s_b_json_parser.php" alt="SBJsonParser" shape="rect" coords="103,112,196,136"/>
<area href="interface_s_b_json_writer.php" alt="SBJsonWriter" shape="rect" coords="206,112,299,136"/>
</map>
</div>

<p><a href="class_s_b_json_base-members.php">List of all members.</a></p>
<table class="memberdecls">
<tr><td colspan="2"><h2><a name="pub-methods"></a>
Public Member Functions</h2></td></tr>
<tr><td class="memItemLeft" align="right" valign="top"><a class="anchor" id="af6fc685c386c1c4528bd30b2bd630d56"></a><!-- doxytag: member="SBJsonBase::addErrorWithCode:description:" ref="af6fc685c386c1c4528bd30b2bd630d56" args="(NSUInteger code,[description] NSString *str)" -->
(void)&nbsp;</td><td class="memItemRight" valign="bottom">- <b>addErrorWithCode:description:</b></td></tr>
<tr><td class="memItemLeft" align="right" valign="top"><a class="anchor" id="a6a429d6db2149fea7435b9e0aac5d3fa"></a><!-- doxytag: member="SBJsonBase::clearErrorTrace" ref="a6a429d6db2149fea7435b9e0aac5d3fa" args="()" -->
(void)&nbsp;</td><td class="memItemRight" valign="bottom">- <b>clearErrorTrace</b></td></tr>
<tr><td colspan="2"><h2><a name="pro-attribs"></a>
Protected Attributes</h2></td></tr>
<tr><td class="memItemLeft" align="right" valign="top"><a class="anchor" id="a9fd64724d5da34a0f9842cee3d14620c"></a><!-- doxytag: member="SBJsonBase::errorTrace" ref="a9fd64724d5da34a0f9842cee3d14620c" args="" -->
<a class="el" href="class_n_s_mutable_array.php">NSMutableArray</a> *&nbsp;</td><td class="memItemRight" valign="bottom"><b>errorTrace</b></td></tr>
<tr><td class="memItemLeft" align="right" valign="top"><a class="anchor" id="a5e80155581d240f565ec4149ad812e03"></a><!-- doxytag: member="SBJsonBase::depth" ref="a5e80155581d240f565ec4149ad812e03" args="" -->
...
<p>Common base class for parsing &amp; writing. </p>
<p>This class contains the common error-handling code and option between the parser/writer. </p>
<hr/><h2>Property Documentation</h2>
<a class="anchor" id="aa83f0ee5efade2fd26ddf6591ffd8dc0"></a><!-- doxytag: member="SBJsonBase::errorTrace" ref="aa83f0ee5efade2fd26ddf6591ffd8dc0" args="" -->
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">- (<a class="el" href="class_n_s_array.php">NSArray</a>*) errorTrace<code> [read, copy]</code></td>
        </tr>
      </table>
</div>
<div class="memdoc">
...
<a class="anchor" id="abe3e47517711570a9a57e2d92a15055b"></a><!-- doxytag: member="SBJsonBase::maxDepth" ref="abe3e47517711570a9a57e2d92a15055b" args="" -->
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
...
<li>extThree20JSON/Vendors/JSON/<a class="el" href="_s_b_json_base_8h_source.php">SBJsonBase.h</a></li>
<li>extThree20JSON/Vendors/JSON/SBJsonBase.m</li>
</ul>
</div>
