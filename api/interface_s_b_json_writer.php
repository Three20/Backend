...
<title>Three20 API: SBJsonWriter Class Reference</title>
...
<div class="contents">
<!-- doxytag: class="SBJsonWriter" --><!-- doxytag: inherits="SBJsonBase" -->
...
<area href="interface_s_b_json_base.php" alt="SBJsonBase" shape="rect" coords="0,56,89,80"/>
...
<tr><td class="memItemLeft" align="right" valign="top">(<a class="el" href="class_n_s_string.php">NSString</a> *)&nbsp;</td><td class="memItemRight" valign="bottom">- <a class="el" href="interface_s_b_json_writer.php#a9018ceff9753092b310a43782c5083ed">stringWithObject:</a></td></tr>
<tr><td class="mdescLeft">&nbsp;</td><td class="mdescRight">Return JSON representation (or fragment) for the given object.  <a href="#a9018ceff9753092b310a43782c5083ed"></a><br/></td></tr>
<tr><td class="memItemLeft" align="right" valign="top">(<a class="el" href="class_n_s_string.php">NSString</a> *)&nbsp;</td><td class="memItemRight" valign="bottom">- <a class="el" href="interface_s_b_json_writer.php#a41cfe2a66c774790785a841633cc0bc4">stringWithObject:error:</a></td></tr>
<tr><td class="mdescLeft">&nbsp;</td><td class="mdescRight">Return JSON representation (or fragment) for the given object.  <a href="#a41cfe2a66c774790785a841633cc0bc4"></a><br/></td></tr>
...
<a class="anchor" id="a9018ceff9753092b310a43782c5083ed"></a><!-- doxytag: member="SBJsonWriter::stringWithObject:" ref="a9018ceff9753092b310a43782c5083ed" args="(id value)" -->
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
...
<a class="anchor" id="a41cfe2a66c774790785a841633cc0bc4"></a><!-- doxytag: member="SBJsonWriter::stringWithObject:error:" ref="a41cfe2a66c774790785a841633cc0bc4" args="(id value,[error] NSError **error)" -->
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
...
<dl><dt><b>Parameters:</b></dt><dd>
  <table border="0" cellspacing="2" cellpadding="0">
    <tr><td valign="top"></td><td valign="top"><em>value</em>&nbsp;</td><td>any instance that can be represented as a JSON fragment </td></tr>
    <tr><td valign="top"></td><td valign="top"><em>error</em>&nbsp;</td><td>pointer to object to be populated with NSError on failure </td></tr>
  </table>
  </dd>
</dl>
...
<li>extThree20JSON/Vendors/JSON/SBJsonWriter.m</li>
</ul>
</div>
