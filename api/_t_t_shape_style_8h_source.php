...
<title>Three20 API: Three20Style/Headers/TTShapeStyle.h Source File</title>
...
<h1>Three20Style/Headers/TTShapeStyle.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00025"></a><a class="code" href="interface_t_t_shape_style.php">00025</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_shape_style.php" title="Causes all layers going forward to use a particular shape.">TTShapeStyle</a> : <a class="code" href="interface_t_t_style.php">TTStyle</a> {
<a name="l00026"></a>00026   <a class="code" href="interface_t_t_shape.php">TTShape</a>* _shape;
<a name="l00027"></a>00027 }
<a name="l00028"></a>00028 
<a name="l00029"></a>00029 @property (nonatomic, retain) <a class="code" href="interface_t_t_shape.php">TTShape</a>* shape;
<a name="l00030"></a>00030 
<a name="l00031"></a>00031 + (<a class="code" href="interface_t_t_shape_style.php" title="Causes all layers going forward to use a particular shape.">TTShapeStyle</a>*)styleWithShape:(<a class="code" href="interface_t_t_shape.php">TTShape</a>*)shape next:(<a class="code" href="interface_t_t_style.php">TTStyle</a>*)next;
