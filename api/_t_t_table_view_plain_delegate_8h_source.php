...
<title>Three20 API: Three20UI/Headers/TTTableViewPlainDelegate.h Source File</title>
...
<h1>Three20UI/Headers/TTTableViewPlainDelegate.h</h1>  </div>
</div>
<div class="contents">
...
<a name="l00023"></a><a class="code" href="interface_t_t_table_view_plain_delegate.php">00023</a> <span class="keyword">@interface </span><a class="code" href="interface_t_t_table_view_plain_delegate.php" title="The most basic delegate.">TTTableViewPlainDelegate</a> : <a class="code" href="interface_t_t_table_view_delegate.php" title="A default table view delegate implementation.">TTTableViewDelegate</a> {
