<div class="grid">
  <div class="row right-border">
    <div class="col-2">Command line (git)
      ...
      <div class="subtext"><code>git checkout v1.0a1</code></div>
    </div>
    <div class="col-2 no-right-border">Download
      <div class="subtext"><a href="http://github.com/facebook/three20/tarball/v1.0a1">Three20-v1.0a1.tar.gz</a></div>
    </div>
